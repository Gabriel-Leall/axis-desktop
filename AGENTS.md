...
This repository is for Axis Desktop, an application built with Tauri and React.
...
0. **Use bun only**: This project uses `bun`, NOT `pnpm`. Always use `bun install`, `bun run`, etc.

...
- Direção visual: produtividade premium e densa, com hierarquia forte e leitura rápida.
- Referências: Linear (clareza operacional), Notion/Obsidian (estrutura e legibilidade), Todoist (priorização objetiva), Habitica (consistência de hábitos), ZenNotes (calma funcional).
- Tema: equilíbrio entre light e dark (50/50), com prioridade imediata em melhorar o dark atual.
- Anti-referências: não definidas no momento.
